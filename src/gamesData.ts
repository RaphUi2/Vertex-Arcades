...
export const GAMES_LIST: GameData[] = [
  ...
  // 5 NEW PAID GAMES (V3.1 EXPANSION)
  {
    ...
    frenchName: 'Cosmic Miner : Void Driller 💎',
    description: 'Forage au cœur d\'astéroïdes spatiaux ! Évitez le magma, gérez le système de refroidissement et extrayez des gemmes de stellarite rares.',
    category: 'survival',
    difficulty: 'Difficile',
    color: 'from-cyan-600 to-blue-800',
    rating: 98,
    activePlayers: '5.6k',
    creator: 'DeepSpace Mining Corp',
    badge: 'VIP 200 VC 💎',
    isPaid: true,
    costVCoins: 200,
    isRankedAvailable: false
  ...
  {
    id: 'shadow_shinobi',
    name: 'Shadow Shinobi: Neon Slash',
    frenchName: 'Shadow Shinobi : Neon Slash 🥷',
    description: 'Infiltration de toits & combat ninja reflex ! Tranchez les gardes cybernétiques au katana laser et lancez des volées de shurikens.',
    category: 'action',
    difficulty: 'Difficile',
    color: 'from-purple-600 to-pink-700',
    rating: 99,
    activePlayers: '7.8k',
    creator: 'Shadow Clan Studios',
    badge: 'VIP 250 VC 🥷',
    isPaid: true,
    costVCoins: 250,
    isRankedAvailable: false
  ...
  {
    id: 'speed_runners_2099',
    name: 'Speed Runners 2099: Grav Track',
    frenchName: 'Speed Runners 2099 : Grav Track ⚡',
    description: 'Course 3D supersonique sur circuit magnétique ! Déclenchez votre propulsion Nitro, absorbez les capsules d\'énergie et pulvérisez les records.',
    category: 'racer',
    difficulty: 'Extrême',
  ...
  {
    id: 'block_craft_arena',
    name: 'Block Craft: Sky Arena',
    frenchName: 'Block Craft : Sky Arena 🧱',
    description: 'Défense voxel stratégique d\'île flottante ! Posez des blocs de fortification en obsidienne, tirez à l\'arc et frappez à l\'épée diamant.',
    category: 'survival',
    difficulty: 'Moyen',
    color: 'from-emerald-500 to-teal-700',
    rating: 96,
    activePlayers: '8.1k',
    creator: 'VoxelCraft Interactive',
    badge: 'VIP 180 VC 🧱',
    isPaid: true,
    costVCoins: 180,
    isRankedAvailable: false
  ...
  {
    id: 'neon_cyber_pong',
    name: 'Neon Cyber Pong: Hyper Rally',
    frenchName: 'Neon Cyber Pong : Hyper Rally 🏓',
    description: 'Duel d\'arcade haute intensité avec physique de balle courbée, smash laser destructeur et intelligence cybernétique adaptative.',
    category: 'action',
    difficulty: 'Moyen',
    color: 'from-cyan-500 to-rose-600',
    rating: 95,
    activePlayers: '3.3k',
    creator: 'RetroWave Lab',
    badge: 'VIP 160 VC 🏓',
    isPaid: true,
    costVCoins: 160,
    isRankedAvailable: false
